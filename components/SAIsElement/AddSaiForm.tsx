...
import { getProvinces, getMunicipalities, addSAI } from '@/lib/seed'
...
const AddSaiForm = () => {
    ...
    const onSubmit: SubmitHandler<ISai> = async (data) => {
        ...
        const newData = {
            ...data,
            province_id: Number(data.province.id),
            municipe_id: Number(data.municipe.name),
