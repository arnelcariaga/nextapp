...
export default function UserProfile({ params, data, session }: IComponentProps) {
    ...
    const renderUserTrackingNumber = (): number => {
        ...
        // }
        return Number(data?.trackings_count)
    }
        ...
        <div className="container mx-auto p-4 max-w-full">
            <div className="flex flex-col lg:flex-row gap-6">
                <div className="w-full lg:w-2/3">
                    <UserDetailsHeader
                        userDetails={data as ICommunityOperationUserDetails}
                        canEdit={canEdit}
                        showDescription
                    />
                </div>
                {
                    ...
                    data?.serology_status.id === 2 ? null :
                        data?.serology_status.id === 1 ?
            ...
            <MyDialog
                ...
                content={<AddIndexForm
                    params={params}
                    userName={data?.name + " " + data?.last_name}
                    userFappId={data?.fapps_id as number}
                    setCountEnrolling={()=>{}}
            ...
            <MyDialog
                ...
                description=""
                content={
                    <EditCommunityOperationUserForm selectedItem={data} />
                }
                btnTrigger={<></>}
